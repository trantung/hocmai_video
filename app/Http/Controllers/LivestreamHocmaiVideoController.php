...
class LivestreamHocmaiVideoController extends Controller
{
    /**
    ...
    {
        $data = Livestream::all();
        return view('livestream_hocmai_video.index')->with(compact('data'));
    }
    ...
    {
        return view('livestream_hocmai_video.create');
    }   
