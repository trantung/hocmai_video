...
<div class="col-md-12 col-sm-12  ">
  <div class="x_panel">
    <div class="x_title">
      <h2 class="navbar-left">Thêm mới && <a href="{{ action('VideoController@index') }}" style="color:darkred">Trở lại</a></h2>
    ...
    <div class="x_content">
      ...
      <div class="form-group row">
        <div class="col-md-4 col-sm-4  form-group has-feedback">
            <label class="control-label col-md-4 col-sm-4">Khối</label>
            <div class="col-md-10 col-sm-10 ">
              {{ Form::select('schoolbock_id', getListKhoi(), array('class' => 'form-control')) }}
            </div>
        </div>
        <div class="col-md-4 col-sm-4  form-group has-feedback">
            <label class="control-label col-md-4 col-sm-4">Lớp </label>
            <div class="col-md-10 col-sm-10 ">
