        ...
        <div id="step-11">
            ...
            <form class="form-horizontal form-label-left">
                <div class="form-group row">
                    ...
                    <button class="col-form-label col-md-2 col-sm-2 btn btn-secondary" for="first-name" style="margin:0 0">Load video
                    </button>
                </div>
                <div class="form-group row">
            ...
            <from class="form-horizontal form-label-left">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-6 col-sm-3">
                        ...
                        <!-- Uploaded image area-->
                        <div class="col-md-3"><img id="imageResult" src="#" alt="" class=" rounded shadow-sm d-block" style="border: 1px solid #333;width:200px;height:100px"></div>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-lg-6 col-sm-3">
                        ...
                        <!-- Upload image input-->
                        <div class="col-md-6">
                            <img id="imageResult1" src="#" alt="" class=" rounded shadow-sm d-block" style="border: 1px solid #999;width:400px;height:200px" ></div>
                    </div>
                </div>
            </from>
        </div>
