      ...
      {{ Form::open(array('action' => array('EventController@update', $event->id), 'method' => "PUT", 'files' => true)) }}
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12">
              ...
              {{ Form::text('urlWebView', $event->urlWebView, array('class' => 'form-control')) }}
          </div>
          <div class="col-md-12 col-sm-12">
              <lable class="text-label">Deep Link</lable>
              {{ Form::text('deep_link', $event->deep_link, array('class' => 'form-control')) }}
          </div>
          <div class="col-md-12 col-sm-12">
              <lable class="text-label">Event Adjust</lable>
              {{ Form::text('event_adjust', $event->event_adjust, array('class' => 'form-control')) }}
          </div>
          <div class="col-md-12 col-sm-12">
        ...
        <div class="row form-group">
            <div class="col-md-6 col-lg-6">
                <label class="col-lg-2">Màn hình ngang dọc</label>
                <div class="col-md-8 col-sm-8 col-lg-8">
                    {{ Form::select('is_screen', getIsScreen(), $event->is_screen,array('class' => 'form-control')) }}
                </div>
            </div>
            <div class="col-md-6 col-lg-6">
                <label class="col-lg-2">Yêu cầu active</label>
                <div class="col-md-8 col-sm-8 col-lg-8">
                    {{ Form::select('is_active', getIsActive(), $event->is_active,array('class' => 'form-control')) }}
                </div>
            </div>
