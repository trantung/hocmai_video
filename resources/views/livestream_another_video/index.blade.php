...
@section('content')
<div class="col-md-12">
    <div class="title_header float-right">
        < <form action="{{ route('livestream.destroy',$livestream->id)}}" method="POST">
            @csrf
            @method('DELETE')
            <a href="{{ action('LivestreamAnotherVideoController@edit', $livestream->id) }}" title="Sửa" class="text-info"><i class="fa fa-edit"></i></a>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6 col-lg-6 col-sm-6">
                ...
                <div class="col-md-8 col-sm-8 col-lg-8">
                    <input type="text" name="url" id="url" value="{{$livestream->url}}" disabled=true>
                </div>
            </div>
        </div>
        <div class="form-group row">
