...
<div class="col-md-12 col-sm-12  ">
  <div class="x_panel">
    <div class="x_title">
      <h2 class="navbar-left">Thêm mới && <a href="{{ action('SchoolSubjectController@index') }}" style="color:darkred">Trở lại</a></h2>
    ...
    <div class="x_content">
      <br>
      {{ Form::open(array('method'=>'POST', 'action' => array('SchoolSubjectController@store'),'class'=>'form-horizontal form-label-left')) }}
      ...
      <div class="form-group row">
        ...
        <div class="col-md-4 col-sm-4  form-group has-feedback">
            <label class="control-label col-md-4 col-sm-4">Tên Giáo viên</label>
            <div class="col-md-10 col-sm-10 ">
